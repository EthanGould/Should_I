...
class OpinionsControllerTest < ActionController::TestCase
  ...
  test "should create opinion" do
    assert_difference('Opinion.count') do
      post :create, opinion: { option_one: @opinion.option_one, option_one_votes: @opinion.option_one_votes, option_two: @opinion.option_two, option_two_votes: @opinion.option_two_votes, user_id: @opinion.user_id }
    end
  ...
  test "should update opinion" do
    patch :update, id: @opinion, opinion: { option_one: @opinion.option_one, option_one_votes: @opinion.option_one_votes, option_two: @opinion.option_two, option_two_votes: @opinion.option_two_votes, user_id: @opinion.user_id }
    assert_redirected_to opinion_path(assigns(:opinion))
  end
